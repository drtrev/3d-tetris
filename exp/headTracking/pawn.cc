...
// these move functions are for constant movement independent of frame rate
// e.g. for stereoscopic and head tracking
void Pawn::moveLeft( const float amount )
{
  //x += amount * Trig::sn(angleY-90);
  //z += amount * Trig::cs(angleY-90);
  x += amount * sin((angleY-90) / 180.0 * 3.14);
  z += amount * cos((angleY-90) / 180.0 * 3.14);
}

void Pawn::moveRight( const float amount )
{
  //x += amount * Trig::sn(angleY+90);
  //z += amount * Trig::cs(angleY+90);
  x += amount * sin((angleY+90) / 180.0 * 3.14);
...
void Pawn::moveForwards( const float amount )
{
  x += amount * sin(angleY / 180.0 * 3.14);
  z += amount * cos(angleY / 180.0 * 3.14);
}

void Pawn::moveBackwards( const float amount )
{
  x += amount * sin((angleY+180) / 180.0 * 3.14);
  z += amount * cos((angleY+180) / 180.0 * 3.14);
}
